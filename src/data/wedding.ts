...
/**
 * «Три цветка» — что гости приносят вместо букета.
 * Из них на месте собирается убранство столов.
 */
export const FLOWERS_TRIO = [
  { n: 'первый', v: 'тот, что у&nbsp;вас связан с&nbsp;Никитой' },
  { n: 'второй', v: 'тот, что для&nbsp;вас похож на&nbsp;Леру' },
  { n: 'третий', v: 'тот, в&nbsp;котором вы&nbsp;видите нас двоих' },
] as const;
...
export const TIMELINE = [
  { h: '15', m: ':00', title: 'Сбор гостей', note: 'Фуршет' },
...
/**
 * «Коротко о главном». `anchor` — необязательная ссылка на секцию
 * ниже по странице; выводится строкой под значением.
 */
...
export const RULES = [
  {
    k: 'О&nbsp;детях',
    v: 'Будет громко и&nbsp;допоздна, а&nbsp;тихого уголка на&nbsp;площадке нет. Малышей до&nbsp;школьного возраста лучше оставить дома под&nbsp;любящим присмотром&nbsp;— и&nbsp;выдохнуть вместе с&nbsp;нами.',
  },
  {
    k: 'Без «Горько!»',
